...
<div class="block-split__item block-split__item-content col-auto">
	...
	C6,14.8,5.8,15,5.5,15h-2C3.2,15,3,14.8,3,14.5v-3C3,11.2,3.2,11,3.5,11z" />
                        ...
                        <span class="filters-button__title">{{ __('global.Filters') }}</span>
...
{{--                        نمایش ۶ از ۱۰۰ مورد محصول--}}
{{--                    </div>--}}
                    <div class="view-options__spring"></div>
{{--                    <div class="view-options__select">--}}
{{--                        <label for="view-option-sort">{{ __('global.Sort') }}:</label>--}}
{{--                        <select id="view-option-sort" class="form-control form-control-sm" name="filterBy">--}}
{{--                            <option value="price">{{ __('global.Price') }}</option>--}}
{{--                            <option value="">{{ __('global.Price') }}</option>--}}
{{--                        </select>--}}
{{--                    </div>--}}
{{--                    <div class="view-options__select">--}}
{{--                        <label for="view-option-limit">{{ __('global.Show') }}:</label>--}}
...
{{--                </div>--}}
            ...
            <div class="products-view__list products-list products-list--grid--4" data-layout="list" data-with-features="false">
                <div class="products-list__head">
                    <div class="products-list__column products-list__column--image">{{ __('global.Image') }}</div>
                    <div class="products-list__column products-list__column--meta">{{ __('global.SKU') }}</div>
                    <div class="products-list__column products-list__column--product">{{ __('global.Product Name') }}</div>
                    <div class="products-list__column products-list__column--rating">{{ __('global.Rating') }}</div>
                    <div class="products-list__column products-list__column--price">{{ __('global.Price') }}</div>
                </div>
...
{{--                                                        ۲--}}
{{--                                                        <span class="sr-only">({{ __('global.current') }})</span>--}}
{{--                                                    </span>--}}
{{--                        </li>--}}
