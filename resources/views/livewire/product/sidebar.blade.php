                                        ...
                                        <div class="filter-categories">
                                            <ul class="filter-categories__list">
                                                <li class="filter-categories__item filter-categories__item--current">
                                                    <a href="">دسته بندی لایه اول</a>
                                                    <div class="filter-categories__counter">۳۳۳</div>
                                                </li>
                                                <li class="filter-categories__item filter-categories__item--child">
                                                    <a href="">دسته بندی لایه دو</a>
                                                    <div class="filter-categories__counter">۱۲</div>
                                                </li>
                                                <li class="filter-categories__item filter-categories__item--child">
                                                    <a href="">دسته بندی لایه دو</a>
                                                    <div class="filter-categories__counter">۲۳۲</div>
                                                </li>
                                                <li class="filter-categories__item filter-categories__item--child">
                                                    <a href="">دسته بندی لایه دو</a>
                                                ...
                                                <li class="filter-categories__item filter-categories__item--current">
                                                    <a href="">دسته بندی لایه اول</a>
                                                    <div class="filter-categories__counter">۷</div>
                                                </li>
                                                <li class="filter-categories__item filter-categories__item--child">
                                                    <a href="">دسته بندی لایه دو</a>
                                                    <div class="filter-categories__counter">۵</div>
                                                </li>
                                                <li class="filter-categories__item filter-categories__item--current">
                                                    <a href="">دسته بندی لایه اول</a>
                                                    <div class="filter-categories__counter">۲</div>
                                                </li>
                                                <li class="filter-categories__item filter-categories__item--child">
                                                    <a href="">دسته بندی لایه دو</a>
                                                    <div class="filter-categories__counter">۹</div>
                                                </li>
                                                <li class="filter-categories__item filter-categories__item--child">
                                                    <a href="">دسته بندی لایه دو</a>
                                                    <div class="filter-categories__counter">۴</div>
                                                </li>
                                                <li class="filter-categories__item filter-categories__item--child">
                                                    <a href="">دسته بندی لایه دو</a>
                                                    <div class="filter-categories__counter">۰</div>
                                                </li>
                                                <li class="filter-categories__item filter-categories__item--child">
                                                    <a href="">دسته بندی لایه دو</a>
                                                    <div class="filter-categories__counter">۱۴</div>
                                                </li>
                                                <li class="filter-categories__item filter-categories__item--child">
                                                    <a href="">دسته بندی لایه دو</a>
                                                    <div class="filter-categories__counter">۸</div>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                        ...
                                        <div class="filter-list">
                                            <div class="filter-list__list">
                                                <label class="filter-list__item ">
                                                    ...
                                                    <span class="filter-list__counter">۱۲</span>
                                                </label>
                                                <label class="filter-list__item ">
                                                                            <span class="input-check filter-list__input">
                                                                                <span class="input-check__body">
                                                    ...
                                                    <span class="filter-list__counter">۴۴۳</span>
                                                </label>
                                                ...
                                                <label class="filter-list__item ">
                                                    ...
                                                    <span class="filter-list__counter">۱</span>
                                                </label>
                                                <label class="filter-list__item ">
                                                                            <span class="input-check filter-list__input">
                                                                                <span class="input-check__body">
                                                    ...
                                                    <span class="filter-list__counter">۲۲</span>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
